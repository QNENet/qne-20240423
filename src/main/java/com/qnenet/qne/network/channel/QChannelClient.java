...
//            QThreadUtils.setThreadName("C" + String.valueOf(channelInfo.channelId));
...
//                    payload = qobjs.objToBytes(channelInfo);
...
//                bb.putInt(0, channelInfo.responderEPAddr.epIdx);
//                bb.putInt(4, channelInfo.channelId);
//                bb.putInt(8, channelInfo.role);
//                bb.put(12, bytes);
//
//                DatagramPacket writePacket = new DatagramPacket(bb.array(), 0, bb.array().length, destSocketAddress);
...
//    }
//
//    public QEPAddr getResponderEPAddr() {
...
////        String initiatorWanIPAddress = getInitiatorEPAddr().getWanIPAddress();
////        String initiatorLanIPAddress = getInitiatorEPAddr().getLanIPAddress();
////        int initiatorPort = getInitiatorEPAddr().getPort();
////        String responderWanIPAddress = getInitiatorEPAddr().getWanIPAddress();
////        String responderLanIPAddress = getInitiatorEPAddr().getLanIPAddress();
////        int responderPort = getResponderEPAddr().port;
////
