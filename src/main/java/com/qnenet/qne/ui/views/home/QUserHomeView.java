...
@RolesAllowed("USER")
@PageTitle("User Home")
@Route(value = QRoutes.USER_HOME, layout = ContentLayout.class)
public class QUserHomeView extends VerticalLayout implements QView, BeforeEnterObserver, BeforeLeaveObserver {
...
//        setJustifyContentMode(JustifyContentMode.CENTER);
        ...
        H4 h150 = new H4("");
        H4 h160 = new H4("After playing with each button, you will know all you need to know");
        H4 h170 = new H4("to be an expert \"Quick N Easy\" Web Application user.");
